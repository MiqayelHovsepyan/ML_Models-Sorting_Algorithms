...
class DecisionTree:
    def __init__(self, min_sample_split=2, max_depth=120, n_feats=None):
    ...
    def fit(self, X,y):
        ...
        self.root = self._build_tree(self.X_train, self.y_train, depth=0)
    ...
    def _split(self, X_column, split_thresh):
        ...
        right_idxs = np.where(X_column > split_thresh).flatten()
